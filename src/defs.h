...
namespace Defs
{
    const auto APP_VERSION = 0x070004;
    const auto APP_VERSION_STR = QStringLiteral("7.0.4");
...
//    QDataStream& operator>>(QDataStream& in, Defs::RawFileType& fileType);
    ...
    const auto ABOUT_DESC = QObject::tr("LI-COR EddyFlow software suite.");
    ...
    const auto LICOR_EP_VERSION_FILE = QStringLiteral("http://dl.licor.com/EddyFlow/version");
    const auto EP_SAMPLE_DATA_FILES  = QStringLiteral("http://dl.licor.com/EddyFlow/data");
